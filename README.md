...
```sh
brew install zsh antidote fastfetch fzf zoxide yazi bat eza ripgrep fd btop git git-delta neovim tmux stylua prettierd black tex-fmt clangd pyright rust-analyzer typescript-language-server lua-language-server latexmk
```
