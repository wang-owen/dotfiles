...
-- Maps Alt-Backspace to Ctrl-w in insert mode
...
function _G.set_terminal_keymaps()
  local opts = { buffer = 0 }
  -- Use <C-w> and a direction to jump out of the terminal
...
-- This line tells Neovim to run the function above whenever a terminal opens
...
require('lazy').setup {
  ...
  { -- Single tabpage interface for cycling through diffs for all modified files for any git rev
